<div id="main_page">
	...
	<?php if(!$user): ?>
		...
		<p>If you are not yet a member, please <a href="/users/signup" class="userlink">sign up</a>!</p><br><br>


	<?php else: ?>
		<h1>Welcome Back to Baking Bites, <?=$user->first_name ?>!</h1>
		<p>
		Ever dying to bake something, but what can you bake with the 
		few items lurking in your kitchen, you ask yourself? Two bananas, eggs, a chocolate bar, and sugar. 
		Yes, you could endlessly peruse the internet until you find just the perfect recipe that needs no more 
		and no less than what you have, or you could <a href='/recipes/search'>search</a> Baking Bites! Baking Bites is the perfect place 
		to share your favorite recipes and to find the perfect recipe for your ingredient needs. 
		</p>
